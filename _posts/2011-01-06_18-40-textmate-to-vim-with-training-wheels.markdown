...
And since you can do a lot of things with the primitives, there's little need for TextMate's modifier-heavy keyboard shortcuts. I actually remember Vim commands as commands – with TextMate, it's mostly chord muscle memory.
